...
//go:generate ./inquisitor.sh generic/inquisitor.go.erb
//go:generate ./inquisitor.sh generic/inquisitor_test.go.erb

//go:generate genny -in generic/generic-setup_test.go -out app-setup_test.go -pkg query_test gen Item=App
//go:generate genny -in generic/generic.go -out app-service.go -pkg query gen Item=App
//go:generate genny -in generic/generic_test.go -out app-service_test.go -pkg query_test gen Item=App
...
//go:generate genny -in generic/generic.go -out space-service.go -pkg query gen Item=Space
//go:generate genny -in generic/generic_test.go -out space-service_test.go -pkg query_test gen Item=Space
...
//go:generate genny -in generic/generic.go -out org-service.go -pkg query gen Item=Org
//go:generate genny -in generic/generic_test.go -out org-service_test.go -pkg query_test gen Item=Org
...
//go:generate genny -in generic/generic.go -out buildpack-service.go -pkg query gen Item=Buildpack
//go:generate genny -in generic/generic_test.go -out buildpack-service_test.go -pkg query_test gen Item=Buildpack
...
//go:generate genny -in generic/generic.go -out stack-service.go -pkg query gen Item=Stack
//go:generate genny -in generic/generic_test.go -out stack-service_test.go -pkg query_test gen Item=Stack
