...
func OrgFilterBy(items Orgs, check func(cfclient.Org) (bool, error)) (Orgs, error) {
	pool := make(Orgs, 0)
...
func OrgFilterMapBy(items OrgMap, check func(cfclient.Org) (bool, error)) (OrgMap, error) {
	pool := make(OrgMap, 0)
