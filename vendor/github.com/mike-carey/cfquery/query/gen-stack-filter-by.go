...
func StackFilterBy(items Stacks, check func(cfclient.Stack) (bool, error)) (Stacks, error) {
	pool := make(Stacks, 0)
...
func StackFilterMapBy(items StackMap, check func(cfclient.Stack) (bool, error)) (StackMap, error) {
	pool := make(StackMap, 0)
