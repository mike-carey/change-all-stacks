...
func (d *DataEntry) String() string {
	return fmt.Sprintf("{ foundation: %s, org: %s, space: %s, app: %s, latestUpload: %s, latestAuthor: %s }", d.Foundation, d.Org.Name, d.Space.Name, d.App.Name, d.LatestUpload, d.LatestAuthor.Username)
}
